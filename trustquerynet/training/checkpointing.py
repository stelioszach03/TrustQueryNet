...
def load_checkpoint(path: str | Path, model, optimizer=None, *, map_location=None) -> Dict[str, Any]:
    path = Path(path)
    # These checkpoints are generated by this project and may include Python / NumPy
    # metadata inside `extra`, so PyTorch 2.6+'s weights_only=True default is too strict.
    try:
